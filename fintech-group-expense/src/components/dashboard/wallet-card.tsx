      ...
      <div className="relative">
        ...
        <div className="flex items-center gap-3">
          <Link to="/wallet/deposit" className="flex-1">
            <button className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur transition-all font-medium text-sm">
