  ...
  return (
    <GlassCard variant="strong" className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-1">Sign in to your SplitFlow account</p>
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <button className="flex items-center justify-center h-11 rounded-xl border border-border/50 bg-secondary/30 hover:bg-secondary/50 transition-colors">
